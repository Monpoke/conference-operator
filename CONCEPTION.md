# Conception — régie de salle & hub

Ce document rassemble le « pourquoi » : décisions structurantes, surfaces
servies, appairage, pilotage à distance, empaquetage, publication, exploitation
d'OBS. Il portait le nom de README jusqu'à ce que celui-ci soit réduit au
démarrage — **pour installer et lancer, lire [README.md](README.md)**.
