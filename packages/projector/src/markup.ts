...
/**
 * The stage's decor — stripes, rings and floating bubbles — on its own: the
 * VOD's intro and outro sit on the same backdrop the room projected.
 */
export function decorMarkup(): string {
